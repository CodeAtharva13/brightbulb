      ...
      <div className="py-16 bg-white relative z-0">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto relative">
            {/* Flip to find out text with arrow - positioned above first card */}
            <div className="absolute -top-16 left-0 z-10 lg:block hidden">
              <div className="relative">
                <p className="text-lg font-bold text-purple-600 mb-2 font-serif italic transform -rotate-12">
                  Flip to find out!
                </p>
                <div className="flex items-center justify-center">
                  <svg 
                    className="w-16 h-12 text-purple-500 transform rotate-45" 
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
